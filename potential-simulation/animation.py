...
class AnimationObject:
    ...
    def animate(self,show=True,save=False):
        ...
        ani = FuncAnimation(self.fig, self.__animate, interval=40, blit=True, repeat=True, frames=len(self.trapping_sequence),repeat_delay=500)
        if save:
    ...
    def GetFrame(self,i):
        return self.trap.GetFinalPotentials(self.trapping_sequence[i]['iteration'],self.trapping_sequence[i]['name'])